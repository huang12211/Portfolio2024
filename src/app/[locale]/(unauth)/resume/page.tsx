  ...
  return (
    <div className="mx-auto max-w-screen-xl px-16 pb-4">
      <div>
        ...
        >
          <div className="mx-auto flex w-[45%] justify-center gap-2 rounded-full border-4 border-gray-700 px-6 py-2 text-base shadow-xl duration-150 hover:scale-110 hover:bg-purple-400 hover:font-bold md:text-xl">
            <p>Download CV </p>
