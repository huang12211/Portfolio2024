  ...
  return (
    <div className="mx-auto max-w-screen-xl px-6 pb-4 pt-16 md:px-16">
      <div>
        ...
        >
          <div className="mx-auto my-6 flex w-3/5 items-center justify-center gap-2 rounded-full border-4 border-gray-700 px-6 py-2 text-base shadow-xl duration-150 hover:scale-110 hover:bg-teal-600 hover:font-bold md:w-[45%] md:text-xl">
            <p>Download CV </p>
